...
use Service\Payment\Vnpay\Models\ATMPay;
use Service\Payment\Vnpay\MethodSupport\InfoRequestATM;
...
class ATM extends ApiRequest
{
    ...
    private function createWalletVnpayRequest($wallet , $data): ATMPay
    {
